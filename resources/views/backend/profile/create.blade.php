                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="user_name" class="form-control" placeholder="" value="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="number_phone" class="form-control" placeholder="" value="">
                            </div>
                            <div class="form-group">
                                <label for="number_phone">Vai trò thành viên <span class="text-danger">*</span></label>
                                <select class="form-control text-left" >
                                    <option>Chọn vai trò thành viên</option>
                                    <option value="0">Khách Hàng (Guest)</option>
                                    <option value="1">Quản trị hệ thống (Admin)</option>
                                    <option value="2">Nhân viên đăng bài (Posting Staff)</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="about_me" id="about_me" class="form-control textarea"></textarea>
                            </div>
